    ...
    <div className="space-y-4">
      ...
      {rows.length > 0 && (
        <Panel bodyClassName="p-0">
          <div className="relative md:grid md:grid-cols-[minmax(0,1fr)_13rem] md:items-start">
            ...
            <div className="pointer-events-none hidden md:sticky md:top-20 md:block md:w-full md:p-2">
              {preview && (
                <div
